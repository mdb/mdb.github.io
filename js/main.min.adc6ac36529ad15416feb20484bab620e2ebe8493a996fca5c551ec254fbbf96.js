document.addEventListener("DOMContentLoaded",()=>{function s(n){let s=document.querySelector("footer ul.ig-feed"),e=document.querySelector("ul.gallery.ig-feed"),t=n.slice(0,8).map(e=>`<li class="item"><a class="thumbnail" href="${e.permalink}"><img src="${e.media_url}" /></a></li>`);s.innerHTML=t.join(''),e&&(e.innerHTML=t.join(''))}fetch("https://www.mikeball.info/ig-feed/ig/media.json").then(e=>e.json()).then(s);let e=document.querySelector("ul.gallery.store-feed");if(!e)return;function o(t){let n=document.querySelector("footer ul.store-feed");e=document.querySelector("ul.gallery.store-feed"),items=t.slice(0,4).map(e=>{let t=`https://tiendah.bigcartel.com/${e.url}`;return`
            <li class="item">
