document.addEventListener("DOMContentLoaded",()=>{function t(e){e.style.transition="opacity 2s",e.style.opacity="1"}function s(){const e=document.getElementsByTagName("img");for(let n of e)n.complete&&t(n),n.addEventListener("load",()=>{t(n)})}function r(e){const t=document.querySelectorAll("ul.ig-feed"),n=e.map(e=>`
          ...
          </li>`).join("");t.forEach(e=>e.innerHTML=n)}function l(){return fetch("https://mikeball.info/feeder/feeds/github-contributions.json").then(e=>e.json()).then(a)}Promise.all([c(),i()]).then(s);const n=document.getElementsByTagName("button")[0],e=n.parentElement;n.addEventListener("click",()=>{if(e.className===""){e.className="toggled";return}e.className=""})})